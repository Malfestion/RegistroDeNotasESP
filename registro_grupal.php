...
?>
    ...
    <body>
        ...
        <div class="container" style="margin-top: 80px; margin-bottom: 80px;">
            ...
            <ul>
                <li>
                    <p>El botón para agregar las notas a la Base de Datos se encuentra al final de esta lista para agregar notas de estudiantes.</p>
                </li>
                <li>
                    <p>En el caso en que el estudiante no desee continuar los cursos, agregar la marca en el el checkbox de "RJ". Esto
                        registrará automáticamente un Retiro Justificado en el sistema.</p>
                </li>
                <li>
                    <p>El checkbox de "Retiro Injustificado" Sobreescribe el checkbox de "Retiro Justificado", registrando automáticamente un Retiro Injustificado en el sistema y una nota de 0.</p>
                </li>
                <li>
            ...
            <form action="php/insert_nota_grupal.php" method="POST">
                <div class="d-inline-flex">
                    ...
                    <div class="mb-3 p-3">
                        ...
                        <input type="text" class="form-control" id="nombre_grupo" name="nombre_grupo" placeholder="Siglas del grupo" required="required" maxlength="10">
                    </div>
                    <div class="mb-3  p-3">
                ...
                ?>
                <input type="submit" class="btn btn-primary" style="margin-left: 15px;" value="Agregar Notas a la Base de Datos" onclick="return confirm('Realmente quiere registrar este grupo de notas?')">
